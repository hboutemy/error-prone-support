...
final class JUnitValueSourceTest {
  ...
  // - Make sure that extra-arg `arguments` aren't flagged.
  ...
  // - Verify that `Arguments.argument(..)` and `Arguments.of(..)` are recognized.
  // - Make sure that value factories with multiple `return` statements aren't flagged.
